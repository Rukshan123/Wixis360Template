...
```html
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="dist/img/wixis360.png" alt="wixis360 Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">wixis360 </span>
    </a>
...
<a href="#" class="brand-link logo-switch">
  <img src="dist/img/logo-xs.png" alt="wixis360 Docs Logo Small" class="brand-image-xl logo-xs">
  <img src="dist/img/logo-xl.png" alt="wixis360 Docs Logo Large" class="brand-image-xs logo-xl" style="left: 12px">
</a>
```
