...
> ##### Reminder!
> wixis360 uses all of Bootstrap 4 components. It's a good start to review the [Bootstrap documentation](http://getbootstrap.com) to get an idea of the various components that this documentation __does not__ cover.
{: .quote-orange .mt-0}
...
Top navbar example can be found in this [demo page](https://wixis360.io/themes/dev/wixis360/pages/layout/top-nav.html). 


<nav class="navbar navbar-expand navbar-light navbar-white">
  <div class="container">
    <a href="index3.html" class="navbar-brand">
      <img src="{{'assets/img/wixis360Logo.png' | relative_url}}" alt="wixis360 Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">wixis360 3</span>
    </a>
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
...
```html
  ...
  <nav class="main-header navbar navbar-expand navbar-light navbar-white">
    <div class="container">
      <a href="index3.html" class="navbar-brand">
        <img src="dist/img/wixis360Logo.png" alt="wixis360 Logo" class="brand-image img-circle elevation-3"
             style="opacity: .8">
        <span class="brand-text font-weight-light">wixis360 3</span>
      </a>
      <!-- Left navbar links -->
