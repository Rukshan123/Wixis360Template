...
> ##### Tip!
> The [starter page](https://wixis360.io/themes/v3/starter.html) is a good place to start building your app if you'd like to start from scratch.
{: .quote-info .mt-0}
...
wixis360 3.0 provides a set of options to apply to your main layout. Each one of these classes can be added to the body tag to get the desired goal.
...
wixis360 3.0 provides a set of color variations to apply to your sidebar (light & dark) & navbar. You can combine any available color with these class prefixes:
...
> ###### New
> You can use override the link/accent color in wixis360, you can add `.accent-*` to `body`.
{: .quote-info}
