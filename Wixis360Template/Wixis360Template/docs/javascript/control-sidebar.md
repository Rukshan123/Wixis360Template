...
The control sidebar component is part of wixis360's layout as the right sidebar. 
...
###### jQuery
{: .text-bold }
Just like all other wixis360 plugins, you can also activate the toggle button using jQuery by running the following example. 
```js
